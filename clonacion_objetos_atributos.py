...
print(f'Son los mismos objetos(mismareferenciua)?: {punto_a is punto_b}')

# Clase Rectangulo utiliza dos puintos superior izquierdo e inferior derecho
class Rectangulo:
...
rect_a.inf_der.y = 6
print(f' Cambio en un punto afecta al otro rectangulo(shallow)')
print(f' REctangulo a : {rect_a}')
print(f' REctangulo b : {rect_b}')

# Creacion de un copia profunda(deep copy)
